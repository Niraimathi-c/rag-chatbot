...
# genai.configure(api_key="AIzaSyB6DG2SVdXcJJdgLDMV5tyuzSu-Opr1gsQ")

# # 1. Load multilingual embedding model
# embed_model = SentenceTransformer("sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")

# # 2. Load dataset (English, Hindi, Tamil)
...
#     Rules:
#     - Understand queries in English, Hindi, and Tamil.
#     - Always reply in the same language as the user’s question.
#     - If the answer is not found in context, politely say you don't know.
#     """
...
#     print("🎓 Multilingual Campus Chatbot (English + Hindi + Tamil)")
